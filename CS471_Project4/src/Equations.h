...
/*!
 * \file Equations.h
 * \brief This is where the methods for the calls in src/TestTypes.c are defined.
 *
 *  Here we define and describe the methods which are referenced in src/TestTypes.c and implemented in src/Equations.c.
