 ...
 *  and implemented in src/Init.c. Based on the input from the init file, we read in all the lines and process the
...
///
/// \param progInfo - The reference to the Info struct for this series of tests defined in src/Utilities.h
...
///
/// Failure: A value which does not convert to an interger greater than or equal to MINIMUM_ITERATIONS defined in src/Utilities.h
/// \param arg - The portion of the line containing the values to store
/// \param progInfo - The reference to the Info struct for this series of tests defined in src/Utilities.h
/// \return 0 for success, -1 on failure;
...
/// \brief This is the method which processes the velocity dampener value applied in src/PSO.c from the line containing this information.
///
/// Failure: A value which does not convert to a positive real number
/// \param arg - The portion of the line containing the values to store
/// \param progInfo - The reference to the Info struct for this series of tests defined in src/Utilities.h
...
/// \brief This is the method which processes the personal best modification factor applied in src/PSO.c from the line containing this information.
///
...
/// \brief This is the method which processes the global best modification factor applied in src/PSO.c from the line containing this information.
///
/// Failure: A value which does not convert to a positive real number between (0, 2]
/// \param arg - The portion of the line containing the values to store
/// \param progInfo - The reference to the Info struct for this series of tests defined in src/Utilities.h
